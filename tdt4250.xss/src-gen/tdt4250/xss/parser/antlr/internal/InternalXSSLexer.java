...
public class InternalXSSLexer extends Lexer {
    ...
    public final void mRULE_NAME() throws RecognitionException {
        try {
            int _type = RULE_NAME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:250:11: ( ( RULE_ID | '-' )+ )
            // InternalXSS.g:250:13: ( RULE_ID | '-' )+
            {
            // InternalXSS.g:250:13: ( RULE_ID | '-' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_SEL() throws RecognitionException {
        try {
            int _type = RULE_SEL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:252:10: ( ( '::' | ':' | '.' | '#' )? RULE_NAME ( ( ( '>' | '+' | '~' ) | ( '::' | ':' | '.' | '#' ) | ( '>' | '+' | '~' ) ( '::' | ':' | '.' | '#' ) ) RULE_NAME )* )
            // InternalXSS.g:252:12: ( '::' | ':' | '.' | '#' )? RULE_NAME ( ( ( '>' | '+' | '~' ) | ( '::' | ':' | '.' | '#' ) | ( '>' | '+' | '~' ) ( '::' | ':' | '.' | '#' ) ) RULE_NAME )*
            {
            // InternalXSS.g:252:12: ( '::' | ':' | '.' | '#' )?
            int alt2=5;
            switch ( input.LA(1) ) {
                case ':':
                    {
            ...
            mRULE_NAME(); 
            // InternalXSS.g:252:42: ( ( ( '>' | '+' | '~' ) | ( '::' | ':' | '.' | '#' ) | ( '>' | '+' | '~' ) ( '::' | ':' | '.' | '#' ) ) RULE_NAME )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalXSS.g:252:43: ( ( '>' | '+' | '~' ) | ( '::' | ':' | '.' | '#' ) | ( '>' | '+' | '~' ) ( '::' | ':' | '.' | '#' ) ) RULE_NAME
            	    {
            	    // InternalXSS.g:252:43: ( ( '>' | '+' | '~' ) | ( '::' | ':' | '.' | '#' ) | ( '>' | '+' | '~' ) ( '::' | ':' | '.' | '#' ) )
            	    int alt5=3;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            // InternalXSS.g:254:18: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalXSS.g:254:20: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalXSS.g:254:20: ( '^' )?
            int alt7=2;
            ...
            // InternalXSS.g:254:49: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:256:10: ( ( '0' .. '9' )+ )
            // InternalXSS.g:256:12: ( '0' .. '9' )+
            {
            // InternalXSS.g:256:12: ( '0' .. '9' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:258:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalXSS.g:258:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalXSS.g:258:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalXSS.g:258:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalXSS.g:258:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                    ...
                    break;
                case 2 :
                    // InternalXSS.g:258:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalXSS.g:258:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:260:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalXSS.g:260:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalXSS.g:260:24: ( options {greedy=false; } : . )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:262:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalXSS.g:262:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalXSS.g:262:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:264:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalXSS.g:264:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalXSS.g:264:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt17=0;
            loop17:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXSS.g:266:16: ( . )
            // InternalXSS.g:266:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA18_transitionS = {
            "\11\21\2\20\2\21\1\20\22\21\1\20\1\21\1\15\1\13\3\21\1\16\1\3\1\5\2\21\1\4\1\10\1\12\1\17\12\14\1\11\6\21\27\7\1\1\2\7\3\21\1\6\1\7\1\21\22\7\1\2\7\7\uff85\21",
